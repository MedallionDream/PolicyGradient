...
class Descriptors:
    ...
    @staticmethod
    def compute_coef_of_var(prices: np.ndarray, window: int = 64) -> np.ndarray:
    ...
    @staticmethod
    def compute_normalized_grad(prices: np.ndarray, window: int = 14) -> np.ndarray:
        if len(prices) < window:
            return np.array([])
    ...
    @staticmethod
    def compute_normalized_price(prices: np.ndarray, window: int = 64) -> np.ndarray:
        if len(prices) < window:
            return np.array([])
    ...
    @staticmethod
    def compute_z_score(prices: np.ndarray, window: int = 64) -> np.ndarray:
        if len(prices) < window:
            return np.array([])
